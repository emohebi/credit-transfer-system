...
if __name__ == "__main__":
    # Test cases
    test_texts = [
        'Some text assistantfinal here is data [{"name": "John", "age": 30}, {"name": "Jane", "age": 25}] more text',
        'No assistant term but has JSON [{"id": 1, "value": "test"}, {"id": 2, "value": "data"}] in text',
        'Text with assistantfinal[{"key": "value"}] and another JSON [{"other": "data"}]',
        '''Multi-line text
        assistantfinal
        [
            {
